...
public class SyftGeneratorRelease extends GeneratorRelease {

    public SyftGeneratorRelease(Path repository, long projectId) {
    ...
    public SbomFilesModel generate() {
        ...
        String command = String.format("syft %s -o spdx-json=%s -o cyclonedx-json=%s", getRepository(), spdxOutput, cdxOutput);
