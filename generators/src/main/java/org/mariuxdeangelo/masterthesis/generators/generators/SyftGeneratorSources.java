...
public class SyftGeneratorSources extends GeneratorSources {

    public SyftGeneratorSources(Path sources, long projectId) {
    ...
    public SbomFilesModel generate() {
        ...
        String command = String.format("syft %s -o spdx-json=%s -o cyclonedx-json=%s", getSources(), spdxOutput, cdxOutput);
